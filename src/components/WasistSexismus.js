  ...
  <React.Fragment>
    <div className="textbox">
      ...
      <article className="text">
        ...
        verschiedene Realisierungsformen, die unseren Alltag durchziehen. Texte
        über verschiedene Realisierungsformen könnt ihr lesen, indem ihr die
    ...
    <div className="textbox2">
      ...
      <article className="text2">
        ...
        „männlichen“ noch der „weiblichen“ Form identifizieren können und/oder
        möchten, sichtbar gemacht werden. Wir schreiben das Wort Hetar@ mit
        einem @, auf diese Art und Weise steht es sowohl für Hetera als auch für
        Hetero.
      </article>
    </div>
  </React.Fragment>
